  ...
  return (
    <main className={styles.accommodationMain}>
      ...
      <div className={styles.accommodationInfo}>
        ...
        2. The student allotted a room in the hostel will be fully responsible for the furniture and electrical fittings/provisions made in the room. Damage/ misuse of facilities provided in the hostel rooms and common areas, mess and dining areas will attract penalty.<br/><br/>
        3. Students must occupy rooms specifically allotted to them. No request for change of rooms will be entertained unless otherwise merited on genuine grounds decided by institute authorities.<br/><br/>
        4. All residents must maintain standards of behavior expected of students of a prestigious Institution such as ours. All residents are required to carry their valid Identity Cards issued to them by the VASHISHT team.<br/><br/>
        5. The students are advised not to keep large amount of cash or valuables in the room. The student is responsible for the safety of his/her belongings inside the room.<br/><br/>
        6. Cooking inside the hostel rooms is strictly prohibited. The electric points provided in each room are to be used only for mobile phone, laptop charging and mosquito repellant. Use of any other electric appliances in the hostel is strictly prohibited.
        </div>
        <br/>
      </div>
